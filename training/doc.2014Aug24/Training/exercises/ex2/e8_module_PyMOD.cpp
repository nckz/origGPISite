 ...
 */
/*                used by pThread    used by pThread,   arg1 */
...
{ 
     ...
     * interface requires all input variables to be pointers.  The 'n'
     * corresponds to the number of input variables to the function pointer
     * 'doSomething()' (not counting 'num_threads' and 'cur_thread').
     */
    coutv(*out);
